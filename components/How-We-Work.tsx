...
const HowWeWork = () => {
  return (
    <div className={cn(montserrat.className, "w-full bg-[#F3F4F6] pt-24 pb-10 px-10 sm:px-0")}>
      <div className="max-w-6xl mx-auto flex flex-col text-center">
        <h2 className="font-extrabold text-4xl">How We Work</h2>
        <p className="text-slate-600 max-w-md mx-auto pt-6">
      ...
      <div className="grid md:grid-cols-3 max-w-5xl gap-20 mx-auto pt-8 ">
        {steps.map((step) => (
