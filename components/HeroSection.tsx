...
const HeroSection = () => {
  return (
    <div className="max-w-6xl bg-[##F3F4F6] relative mx-auto h-screen sm:h-[600px] sm:flex sm:flex-row flex-col sm:pt-[88px] pt-[60px] px-5">
        <div
          className="absolute block sm:hidden inset-x-0 -top-40 -z-10 transform-gpu overflow-hidden blur-3xl sm:-top-80"
          aria-hidden="true"
        >
          <div
      ...
      <div className="basis-1/2 relative h-full sm:block hidden">
        ...
        <button className="bg-black hover:bg-black/60 cursor-pointer mt-16 mx-16 text-white text-2xl uppercase font-bold p-3 w-1/2 rounded-lg">
            Explore More
