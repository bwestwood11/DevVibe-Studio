    ...
    <div className="flex mx-auto max-w-7xl px-16 max-md:px-8 py-8 scroll-m-10 w-full   ">
      ...
      <article className="mx-auto flex-1  max-w-3xl w-full flex flex-col gap-3  ">
        ...
        {/* <Toolbar
          ...
          youtubeLink={blog.youtube_video}
        /> */}
      </article>

      <div className="xl:block hidden w-[300px] py-4 border-solid border-dark dark:border-light text-dark dark:text-light rounded-lg  p-4 xl:sticky top-20 max-h-[80vh] overflow-hidden overflow-y-auto">
